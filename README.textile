...
"Download the custom hook":raw/master/prepare-commit-msg and install it in your project at @.git/hooks/prepare-commit-msg@. 

h1. Install the custom git/JIRA commands 

Download "git-jirabranch":raw/master/git-jirabranch and "git-jirafix":raw/master/git-jirafix and put them somewhere on your path, so that git picks them up as git extensions.
